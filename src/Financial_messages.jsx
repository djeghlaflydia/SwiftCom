...
const Financial_messages = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost/api/nancial_messages.php', {
      headers: {
  ...
  const handleClient = () => {
    setFilterType([103]); // Filter by message types 900 and 910
  };

  const handleInstitue = () => {
    setFilterType([202]); 
  };

  const handleAll = () => {
    setFilterType([103,202]); 
  };

  return (
    <div className='min-h-screen bg-[#ededed] font-medium relative'>
      <Header />
      <h1 className='text-4xl pl-80 font-serif font-bold bg-gradient-to-r from-[#1b0000] via-[#7b01af] to-[#ffffff] bg-clip-text text-transparent w-auto text-center py-10'>Messages financier <span className='text-3xl'> (MT103/MT202)</span></h1>
      ...
      <div className="flex relative">
        ...
        style={{
          ...
          <div className="flex flex-col space-y-5 items-center mt-[-100px] text-[1.3vw] font-bold">
            ...
            <div className='flex items-center justify-center'>
              <button onClick={handleClient} className="font-serif w-[7.3vw] mr-2 mt-5 rounded-lg text-[1.2vw] font-semibold shadow-2xl transition-transform transform hover:scale-105 duration-500 bg-gradient-to-r from-[#dea403] via-[#deb23a] to-[#dac17a] hover:bg-gradient-to-r hover:from-[#c99401] hover:via-[#c69f34] hover:to-[#c2ac6d]">
                Clients (MT103)
              </button>
              <button onClick={handleAll} className="font-serif w-[4.3vw] h-[2.6vw] mr-2 mt-5 rounded-lg text-[1.2vw] font-semibold shadow-2xl transition-transform transform hover:scale-105 duration-500 bg-gradient-to-r from-[#dea403] via-[#deb23a] to-[#dac17a] hover:bg-gradient-to-r hover:from-[#c99401] hover:via-[#c69f34] hover:to-[#c2ac6d]">
                Tout
              </button>
              <button onClick={handleInstitue} className="font-serif w-[7.3vw] mt-5 rounded-lg text-[1.2vw] font-semibold shadow-2xl transition-transform transform hover:scale-105 duration-500 bg-gradient-to-r from-[#dea403] via-[#deb23a] to-[#dac17a] hover:bg-gradient-to-r hover:from-[#c99401] hover:via-[#c69f34] hover:to-[#c2ac6d]">
              Institutes (MT202)
              </button>
            </div>  
        ...
        {isMenuOpen && (
          ...
          style={{
            ...
            <div>
              <button onClick={handleClient} className="font-serif w-[7.7vw] mr-2 h-[2.6vw] rounded-lg text-[1.2vw] font-semibold shadow-2xl transition-transform transform hover:scale-105 duration-500 bg-gradient-to-r from-[#dea403] via-[#deb23a] to-[#dac17a] hover:bg-gradient-to-r hover:from-[#c99401] hover:via-[#c69f34] hover:to-[#c2ac6d]">
                Acceptation
              </button>
              ...
              <button onClick={handleInstitue} className="font-serif w-[7.7vw] h-[2.6vw] rounded-lg text-[1.2vw] font-semibold shadow-2xl transition-transform transform hover:scale-105 duration-500 bg-gradient-to-r from-[#dea403] via-[#deb23a] to-[#dac17a] hover:bg-gradient-to-r hover:from-[#c99401] hover:via-[#c69f34] hover:to-[#c2ac6d]">
                Refuse
              </button>
            </div>  
...
export default Financial_messages;
