...
const FreeMassages = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost/api/free_messages.php', {
      headers: {
  ...
  return (
    <div className='min-h-screen bg-[#ededed] bg-no-repeat bg-cover bg-center font-medium relative'>
      <Header />
      <h1 className='font-serif text-4xl pl-72 font-bold bg-gradient-to-r from-[#1b0000] via-[#7b01af] to-[#ffffff] bg-clip-text text-transparent w-auto text-center py-10'>Messages libre <span className='text-3xl'>(MT999)</span></h1>
