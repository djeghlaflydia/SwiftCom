                ...
                switch ($_GET['type']) {
                    case 'monthly_stats':
                        $sql = "SELECT 
                                    ...
                                    SUM(CASE WHEN sh.mttype='103' THEN 1 ELSE 0 END) AS entre_clients,
                                    SUM(CASE WHEN sh.mttype='202' THEN 1 ELSE 0 END) AS entre_institues
                                FROM swiftcontent s
